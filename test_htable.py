...
def test_single():
    table = htable(5)
    htable_put(table, "ajin", 99)
    assert htable_str(table) == "{ajin:99}"
    assert htable_buckets_str(table) == """0000->
0001->
0002->
0003->ajin:99
...
def test_str_to_list():
    table = htable(5)
    htable_put(table, "ajin", [2, 99, 3942])
    htable_put(table, "tombu", [6, 3, 1024, 99, 102342])
    assert htable_str(table) == "{tombu:[6, 3, 1024, 99, 102342], ajin:[2, 99, 3942]}"
    assert htable_buckets_str(table) == """0000->
